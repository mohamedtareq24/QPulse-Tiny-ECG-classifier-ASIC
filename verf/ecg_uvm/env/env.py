...
class ECGEnv(uvm_env):
    ...
    def connect_phase(self):
        super().connect_phase()
        # TX UVC monitor stream is used for causality sanity: input must precede output.
        self.uart_tx_ag.monitor.ap.connect(self.scoreboard.dut_rx_fifo.analysis_export)
